...
| Tag | Description |
|-----|-------------|
| [`latest`, `stable`, `5.10`](https://github.com/jacobalberty/unifi-docker/blob/master/Dockerfile) | Tracks UniFi stable version - 5.10.19 as of 2019-02-26 |
...
| 5.10.x   | [`5.10.16-sc`](https://github.com/jacobalberty/unifi-docker/blob/5.10.16-sc/Dockerfile) |
